...
# Brand v3: navy #0D1245 fill, solar yellow #FFCC00 letterform —
# yellow-on-navy clears AAA (10.5:1) per the contrast matrix.
TRACKBEE = (
    '<svg viewBox="0 0 14 14" width="14" height="14" '
    'xmlns="http://www.w3.org/2000/svg" aria-label="TrackBee" '
    'style="vertical-align:-3px;display:inline-block">'
    '<rect width="14" height="14" rx="3" fill="#0D1245"/>'
    '<text x="7" y="10" font-size="8" font-weight="700" '
    'font-family="Lexend, Inter Tight, Inter, system-ui" text-anchor="middle" '
    'fill="#FFCC00">TB</text>'
    '</svg>'
)
